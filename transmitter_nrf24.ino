...
data.throttle = mapJoystickValues( analogRead(A0), 0, 255, 1000, 2000 );
data.roll = mapJoystickValues( analogRead(A1), 12, 524, 1020, true );      // "true" or "false" for servo direction | "true" veya "false" servo yönünü belirler
data.pitch = mapJoystickValues( analogRead(A2), 12, 524, 1020, true );     // "true" or "false" for servo direction | "true" veya "false" servo yönünü belirler
data.yaw = mapJoystickValues( analogRead(A3), 0, 255, 1000, 2000 );       // "true" or "false" for servo direction | "true" veya "false" servo yönünü belirler


//data.throttle = mapJoystickValues( analogRead(A0), 0, 1024, 0, 255 );
//data.roll = mapJoystickValues( analogRead(A1), 0, 1024, 0, 255 );      // "true" or "false" for servo direction | "true" veya "false" servo yönünü belirler
//data.pitch = mapJoystickValues( analogRead(A2), 0, 1024, 0, 255 );     // "true" or "false" for servo direction | "true" veya "false" servo yönünü belirler
//data.yaw = mapJoystickValues( analogRead(A3), 0, 1024, 0, 255 );       // "true" or "false" for servo direction | "true" veya "false" servo yönünü belirler
